...
/api/materials/{id}
```
Get infomation about a material
...
/api/materials
```
Get information list all materials
#### Request Headers
...
```json
{
    ...
    "from": 1,
    "last_page": 5,
    "next_page_url": "http://laravel-foodorder.com/api/materials?page=2",
    "path": "http://laravel-foodorder.com/api/materials",
    "per_page": 10,
    "prev_page_url": null,
    "to": 10,
    "total": 50,
    "data": [
        {
            ...
            "category_id": 9,
            "price": "41.00",
            "image": "http://laravel-foodorder.com/images/materials/image.png",

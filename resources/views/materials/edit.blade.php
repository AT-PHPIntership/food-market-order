                    ...
                    <form autocomplete="off" class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 personal-info">
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" value="{{ old('name', $material->name) }}" type="text"
                                           name="name">
                                    @if ($errors->has('name'))
                                        <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" value="{{ old('price', $material->price) }}" type="text"
                                           name="price">
                                    @if ($errors->has('price'))
                                        <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="description">{{ old('description', $material->description) }}</textarea>
